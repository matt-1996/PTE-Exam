      ...
      <div style="position: fixed;
        ...
        <template v-slot:prepend>
            ...
            <v-row   align="center" >
                <v-col cols="auto" offset="0">
                    <!-- <div class=""> -->
                        <img width="70" :src="publicPath + 'images/rl_s_ai.png'" alt="">
                    <!-- </div> -->
                </v-col>
                <v-col cols="3" offset="0" class="">
                    <h2 class="text-3xl  my-2">Re-tell Lecture</h2>
                ...
                <v-row align="center">
                    <v-col cols="12">
                        <ul v-for="retellLecture in retellLectures" :key="retellLecture.id" class="w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <a :href="route('practice.retellLecture.show', retellLecture.id)">
        ...
        <!-- <v-list density="compact" nav>
          ...
          <v-list-item prepend-icon="mdi-account-group-outline" title="Users" value="users"></v-list-item>
            ...
            <v-row>
                <vue-countdown v-if="prepare" :time=" 1 * retellLecture.duration * 1000" v-slot="{ minutes,seconds }" @end="onPrepareEnd">
                    <div class="text-red-400">Prepare: 0{{ minutes }}:{{ seconds }}</div>
                </vue-countdown>

                <vue-countdown v-if="timer" :time=" 1 * retellLecture.duration * 1000" v-slot="{ minutes,seconds }" @end="onTimeEnd">
            ...
            <v-row>
                <v-col>
                    <audio controls >
                        ...
                        <source :src="publicPath + retellLecture.audio_path" type="audio/mpeg">
...
import { onMounted } from 'vue';
    ...
    defineProps({ retellLecture : Object })
