        ...
        <template v-slot:prepend>
            ...
            <v-row   align="center" >
                <v-col cols="auto" offset="0">
                    <!-- <div class=""> -->
                        <img width="70" :src="publicPath + 'images/rs_s_ai.png'" alt="">
                    <!-- </div> -->
                </v-col>
                <v-col cols="3" offset="0" class="">
                    <h2 class="text-3xl  my-2">Repeat Sentence</h2>
                ...
                <v-row align="center">
                    <v-col cols="12">
                        <ul v-for="RepeatSentence in RepeatSentences" :key="RepeatSentence.id" class="w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <a :href="route('practice.repeat.sentence.show', RepeatSentence.id)">
