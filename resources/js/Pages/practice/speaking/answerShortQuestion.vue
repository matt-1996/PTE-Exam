        ...
        <template v-slot:prepend>
            ...
            <v-row   align="center" >
                <v-col cols="auto" offset="0">
                    <!-- <div class=""> -->
                        <img width="70" :src="publicPath + 'images/asq_s_ai.png'" alt="">
                    <!-- </div> -->
                </v-col>
                <v-col cols="3" offset="0" class="">
                    <h2 class="text-3xl  my-2">Answer Short Question</h2>
                ...
                <v-row align="center">
                    <v-col cols="12">
                        <ul v-for="answerShortQuestion in answerShortQuestions" :key="answerShortQuestion.id" class="w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <a :href="route('practice.answerShortQuestion.show', answerShortQuestion.id)">
            ...
            <v-row>
                <v-col>
                    <audio controls >
                        ...
                        <source :src="publicPath + answerShortQuestion.audio_path" type="audio/mpeg">
