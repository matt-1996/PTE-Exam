<template>
    <MainLayout title="questions">
        <v-container>
            ...
            <v-row>
                <vue-countdown v-if="prepare" :time=" 1 * answerShortQuestion.duration * 1000" v-slot="{ minutes,seconds }" @end="onPrepareEnd(answerShortQuestion.duration)">
            ...
            <v-row justify="center" align="center">
                <v-col>
                    <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                        <div class="bg-blue-600 h-2.5 rounded-full" :style="{width:   progressWidth / answerShortQuestion.duration * 100  + '%' }"></div>
                    </div>
                    ...
                    <div class="bg-gray-200 opacity-75 p-4">
                        ...
                        <div class="text-center mt-2">
                            <v-icon id="start" @click="voiceRecorder.record(answerShortQuestion.duration)" class="bg-gray-400 rounded-full p-6">mdi-microphone</v-icon>
