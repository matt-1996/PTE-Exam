<template>
    <MainLayout>
        <v-container>
        <Drawer :datas="Fibs" :links="links" title="Reading：Fill in the Blanks" routeName="practice.r_fib.show" :image="image" />
        <v-row class="mt-2" justify="center" align="center" offset-md="1">
                ...
                <v-col cols="9" class="">
                    <h2 class="text-2xl my-2">Reading：Fill in the Blanks
                        <span class="rounded-md text-sm text-white p-1 bg-green-500">
                        <v-icon class="p-1">mdi-school-outline</v-icon>
                        Study Guide
                    </span></h2>
                    <p>In the text below some words are missing. Drag words from the box below to the appropriate place in the text. To undo an answer choice, drag the word back to the box below the text.</p>
                </v-col>
